    ...
    return (
        <>
            <section className='home'>
                <div className='left'>
                    <h1>Food Recipe</h1>
                    <h5>Love cooking? This app helps you save, organize, and share your favorite recipes. Whether you're a beginner or a pro, you can easily create and explore tasty dishes.</h5>
